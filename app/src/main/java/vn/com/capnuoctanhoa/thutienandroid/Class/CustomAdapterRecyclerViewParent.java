...
//                        String data = mOriginalValues.get(i).getName1();
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerViewHolder(final View itemView) {
            ...
            layoutParent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v.getId() == R.id.layoutParent) {
                        if (layoutChild.getVisibility() == View.VISIBLE) {
                            layoutChild.setVisibility(View.GONE);
                        } else {
            ...
            layoutParent.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            TextView MaDN = (TextView) itemView.findViewById(R.id.lvID);
                            Intent intent;
                            switch (id) {
